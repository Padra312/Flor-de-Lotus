      ...
      child: SafeArea(
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(context,MaterialPageRoute(builder: (context) => const AgendamentoPage()),
    );},
              ...
              child: Text('Agendar', style: AppTextStyles.button.copyWith(fontSize: 14)),
            ),
          ],
        ),
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton.icon(
             onPressed: () {
              Navigator.push(context,MaterialPageRoute(builder: (context) => const SobrePage()),
    );
    },
             icon: const Icon(Icons.arrow_forward_rounded, size: 18),
             label: Text('Veja Mais', style: AppTextStyles.button.copyWith(fontSize: 14)),
             style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.primary,
                foregroundColor: Colors.white,
...
class _SessionsSectionState extends State<SessionsSection> {
  ...
  child: SizedBox(
    ...
    child: FittedBox(
      fit: BoxFit.cover,
      child: massage.imagemUrl != null && massage.imagemUrl!.isNotEmpty
          ? Image.network(
              massage.imagemUrl!,
              fit: BoxFit.cover,
              errorBuilder: (context, error, stackTrace) =>
                  Icon(Icons.image_not_supported, color: AppColors.accent, size: 40),
          ...
          : Container(
              ...
              child: Center(
                child: Icon(Icons.image, color: AppColors.primary, size: 40),
                  ...
                  : Icon(Icons.image_not_supported, size: 64, color: AppColors.accent),
              const SizedBox(height: 16),
              Text(
                massage.descricao ?? "Sem descrição detalhada.",
                style: AppTextStyles.bodyText.copyWith(color: AppColors.text, fontSize: 16),
              ),
            ],
          ),
        ),
  ...
  static const List<Map<String, String>> testimonials = [
    {
      ...
      "text": "Focamos na experiência de imersão. A excelência está na seleção dos óleos essenciais e na qualidade de nossas massagens.",
    ...
    },
    {
      ...
      "text": "Criamos um refúgio para você relaxar e se reconectar. Nossa equipe de massoterapeutas é altamente qualificada.",
       "image": "https://images.pexels.com/photos/846741/pexels-photo-846741.jpeg?auto=compress&cs=tinysrgb&w=800",
    },
    {
      "name": "Isabella Santos",
      "role": "Coordenadora de Bem-Estar & Atendimento",
      "text": "Qualidade e bem-estar são inegociáveis. Somos seu destino de paz, oferecendo alívio das tensões e um momento essencial de autocuidado.",
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildArrowButton(
                  Icons.arrow_back, () => controller.previousPage(
                  duration: const Duration(milliseconds: 300), curve: Curves.ease)),
              const SizedBox(width: 16),
              _buildArrowButton(
                  Icons.arrow_forward, () => controller.nextPage(
                  duration: const Duration(milliseconds: 300), curve: Curves.ease)),
            ],
          ),
        ],
...
class CtaSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
           Text('Pronta para Relaxar?', style: AppTextStyles.headline2),
           const SizedBox(height: 8),
           Text(
      ...
      child: Column(
        children: [
           ...
           Text(
            ...
            style: AppTextStyles.bodyText.copyWith(color: AppColors.accent, fontSize: 12),
          ),
        ],
      ),
    );
